...
// File Uploading Script End
  ...
  $sql = "INSERT INTO products (name, price, image, image_path, description)
  VALUES ('".$name."', '".$price."','".$image."','".$image_path."', '".$description."')";
  //echo $sql;die; 
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <a href='products.php' class="w3-button w3-dark-grey">Products Management <i class="fa fa-arrow-right"></i></a><br /><br />
...
<!-- 
 ...
 -->
      <div class="form-group">
        <label for="fileToUpload">Image <span style='color:red'>*</span></label>
